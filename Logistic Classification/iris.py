...
# li = np.random.rand(15).reshape(5, 3).astype(np.float64)
...
logistic_regression = LogisticRegression(x_train, 100, 5, y_train, li, 0.00005)
...
for i in range(1000):
    ...
    logistic_regression.y = y_train
    """
    logistic_regression.learn(1)
    print("epoch", i, logistic_regression.cost(1))
